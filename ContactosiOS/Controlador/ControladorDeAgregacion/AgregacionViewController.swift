...
class AgregacionViewController: UITableViewController, UITextFieldDelegate {
    ...
    var nuevoContacto: DatosDeContacto? = nil
    var controladorDatosDeContacto: DatosDeContactoController = DatosDeContactoController()
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        override func prepare (for segue: UIStoryboardSegue, sender: Any?) {
            if (segue.identifier == "retornaDone"){ if (!entradaNombre.text!.isEmpty){
                nuevoContacto = DatosDeContacto (
